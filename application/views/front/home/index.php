    ...
    <div class="container-fluid no-padding">
        <div class="row row-no-padding">
            ...
            $slider_position = $this->db->get_where('frontend_settings', array('type' => 'slider_position'))->row()->value;
             $channel_partner_status = $this->db->get_where('frontend_settings',array('type' => 'channel_partner_status'))->row()->value;
             $blog_status = $this->db->get_where('frontend_settings',array('type' => 'blog_status'))->row()->value;
...
<?php
    ...
    if($channel_partner_status=='yes'){
        include_once'channel_partner.php';
    }
    if($blog_status=='yes'){
        include_once'blog_page.php';
    }
