        ...
        <?php if ($i%2 != 0): ?>
            <section class="sct-color-2 <?php if($i == 1){echo 'b-xs-top';}?>">
                <div class="row row-no-padding align-items-center cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-lg-6">
                        <?php
                        if (file_exists('uploads/channel_partner_image/'.$images[0]['img'])) {
                        ?>
                            <a href="<?=base_url()?>home/channel_partners/channel_partner_detail/<?=$value->channel_partner_id?>"><img src="<?=base_url()?>uploads/channel_partner_image/<?=$images[0]['img']?>" class="img-fluid img-center"></a>
                        <?php
                        }
                        else {
                        ?>
                            <a href="<?=base_url()?>home/channel_partners/channel_partner_detail/<?=$value->channel_partner_id?>"><img src="<?=base_url()?>uploads/channel_partner_image/default_image.png" class="img-fluid img-center"></a>
                        <?php
                        }
                        ?>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="col-wrapper--text text-center text-lg-left">
                            <h3 class="heading heading-2 strong-500 text-normal">
                                <a href="<?=base_url()?>home/channel_partners/channel_partner_detail/<?=$value->channel_partner_id?>" class="c-base-1"><?=$value->title?></a>
                            </h3>
