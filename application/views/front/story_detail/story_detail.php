                ...
                <?php
                    ...
                    foreach ($images as $image): ?>
                        <div class="swiper-slide <?php if($i==0){echo 'swiper-slide-active';}?>" data-swiper-autoplay="5000" style="width: 1343px; opacity: 1; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                            <div class="slice holder-item holder-item-light has-bg-cover bg-size-cover" style="background-image: url('<?=base_url()?>uploads/happy_story_image/<?=$image['image']?>'); background-position: bottom bottom;">
                            </div>
                        </div>
                    <?php
                    $i++;
