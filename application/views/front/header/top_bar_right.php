        ...
        <li class="dropdown dropdown--style-2 dropdown--animated float-left">
            <a class="dropdown-toggle has-badge c-base-1" href="<?=base_url()?>home/profile">
            	<?php
	                ...
	                ?>
	                    <div class="top_nav_img" style="background-image: url(<?=base_url()?>uploads/profile_image/male_default.jpg"></div>
	                <?php
	                }
	            ?>
	...
	?>
		...
		?>
<!--		<a class=" blink_text" href="<?=base_url()?>home/download_member_profile_format"  target="_blank" style=" margin: 15px 0px 0px 0px; font-size: 15px; color: #f9430d; font-family: 'FontAwesome';"><i class="fa fa-download"></i> Download Application Form</a>-->
<!--<span class=" blink_text" ></span>-->
        ...
        <!--<li class="dropdown dropdown--style-2 dropdown--animated float-left">-->
        <!--    <?php include 'marriage_application.php'; ?>-->
        <!--</li>-->
