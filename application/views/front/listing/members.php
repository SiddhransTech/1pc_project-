                    ...
                    <?php
                        ...
                        if($pic_privacy_data[0]['profile_pic_show']=='only_me') {?>
                            ...
                            <?php if($member->gender == 1): ?>
                                <div class="listing-image" style="background-image: url(<?=base_url()?>uploads/profile_image/male_default.jpg"></div>
                            <?php else: ?>
                                <div class="listing-image" style="background-image: url(<?=base_url()?>uploads/profile_image/female_default.png"></div>
                            <?php endif; ?>
