...
<div class="sidebar sidebar-inverse sidebar--style-1 bg-base-1 z-depth-2-top">
            ...
            <?php
                ...
                ?>
                 <div style="border: 10px solid rgba(255, 255, 255, 0.1);width: 200px;border-radius: 50%;margin-top: 30px;background: #fff !important;" class="mx-auto">
                        <div class="profile_img" id="show_img" style="background-image: url(<?=base_url()?>uploads/profile_image/male_default.jpg)"></div>
                    </div>
                ...
                ?>
                    <div style="border: 10px solid rgba(255, 255, 255, 0.1);width: 200px;border-radius: 50%;margin-top: 30px;background: #fff;" class="mx-auto">
                        <div class="profile_img" id="show_img" style="background-image: url(<?=base_url()?>uploads/profile_image/male_default.jpg)"></div>
                    </div>
    ...
    <?php } ?>
        ...
        <div class="container">
            <?php if($get_member[0]->image!= "" || $get_member[0]->video!= "") { ?>
                <h6 class="panel-title text-center"><?php echo translate('Birth Kundali and Profile Video');?></h6>
            <?php } ?>
            
            <?php  if(!empty($get_member[0]->image)){          

                $path_info = pathinfo($get_member[0]->image);
                $extension = $path_info['extension'];
                 
            ?>

            <p class="panel-title text-center" style="font-size: 17px; color: #fff;"><?php echo translate('Kundali');?></p>
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <?php if($extension == 'pdf') {?>
                        ...
                        <div class="iframe">
                            <a href="<?php echo base_url()?>uploads/kundali_image/<?php echo $get_member[0]->image;?>" target="imgbox">
                                <iframe src="https://docs.google.com/gview?url=<?php echo base_url()?>uploads/kundali_image/<?php echo $get_member[0]->image;?>&embedded=true" width="250" height="200" alt="image" scrolling="no" style="margin: auto;"></iframe>
                            </a>
                    ...
                    <?php } else {?>
                          <div class="iframe">
                            <a href="<?php echo base_url()?>uploads/kundali_image/<?php echo $get_member[0]->image;?>" target="imgbox">
                                <img src="<?php echo base_url()?>uploads/kundali_image/<?php echo $get_member[0]->image;?>" alt="image" scrolling="no" style="margin: auto;width: 250px;height: 200px;">
                            </a>
                            </div>
                ...
                <div class="col-12 text-center mt-3" >
                    <a href="<?php echo base_url()?>uploads/kundali_image/<?php echo $get_member[0]->image;?>" class="btn btn-md btn1" download ><i class="fa fa-download"></i> Download</a>                    
                </div> 
            </div>               
            ...
            <?php if(empty($get_member[0]->video)){?>
            <?php } else{ ?>
            <p class="text-center mt-5 mb-0" style="font-size: 17px; color: #fff;"><?php echo translate('Profile Video');?></p>
            <div class="row">
                <div class="col-12 text-center">
                    <video controls="" style="width: 250px; height: 200px">
                        <source src="<?php echo base_url()?>uploads/video/<?php echo $get_member[0]->video;?>">
                    </video>
                </div>
            </div>
            <?php } ?>
