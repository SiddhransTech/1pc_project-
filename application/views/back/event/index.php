...
<div id="content-container">
	<div id="page-head">
		...
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<div id="page-title">
			<h1 class="page-header text-overflow" style="display:table-cell"><?= translate('event')?></h1>
		...
		<ol class="breadcrumb">
			...
			<li><a href="#"><?= translate('event')?></a></li>
	...
	<div id="page-content">
	  ...
	  <!--          </div>-->
		    ...
		    <div class="panel-heading">
		        ...
		        <h3 class="panel-title"><?= translate('view_upcoming_event')?></h3>
				</div>
                    ...
                    <div class="row">
                        <table id="contact_messages_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th>
                                    <?php echo translate('event_start_time')?>
                                </th>
                                <th>
...
<style>
    .top-button{
        font-size:1.3rem;
        padding:3.5px 13px;
        border:1px solid #321539;
        color: #321539;
        background: #fff;
        border-radius:5px;
    }
    .top-button:hover{
        background-color: #321539;
        color: #fff;
    }
</style>
