...
<div class="modal fade" id="package_modal" role="dialog" tabindex="-1" aria-labelledby="package_modal" aria-hidden="true">
	...
	<!--view member kundali and video start-->
<div class="modal fade" id="kundali_modal" role="dialog" tabindex="-1" aria-labelledby="kundali_modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><i class="pci-cross pci-circle"></i></button>
                <h4 class="modal-title"><?php echo translate('Image Upload')?></h4>
            </div>
            <!--Modal body-->
...
<div class="modal fade" id="video_modal" role="dialog" tabindex="-1" aria-labelledby="video_modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><i class="pci-cross pci-circle"></i></button>
                <h4 class="modal-title"><?php echo translate('Video Upload')?></h4>
            </div>
            <!--Modal body-->
...
<!--view member kundali and video stop-->
...
<script>
    function view_video(id){
        ...
        $.ajax({
            url: "<?=base_url()?>admin/member_video_modal/"+id,
...
<script>
    function view_kundali(id){
        ...
        /*alert(id);*/
        $.ajax({
            url: "<?=base_url()?>admin/member_kundali_modal/"+id,
            success: function(response) {
...
<script>
     $(document).ready(function(){
         var per = $('#per').val()+ '%';
         var member_id =  "<?php echo $value->member_id?>";
         //alert(per);
         $.ajax({
             url : "<?php echo base_url('admin/update_percentage') ?>",
             type: "POST",
