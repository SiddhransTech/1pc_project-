...
<div id="content-container">
	<div id="page-head">
		...
		<ol class="breadcrumb">
			...
			<li><a href="#"><?= translate('Region Name- Bangalore North West Chapter Name')?></a></li>
	...
	<div id="page-content">
	  ...
	  <!--          </div>-->
		    ...
		    <div class="panel-heading">
		        ...
		        <h3 class="panel-title"><?= translate('Region Name- Bangalore North West Chapter Name- BNI Yellitza')?></h3>
				</div>
	    		...
	    		<div class="col-md-12 form-border">
					<!-- <form action="" method="post"> -->
						<div class="form-group col-md-6">
							<h1 class="panel-title"><?= translate('Visitors entered date:_after')?></h1>
							<h1 class="panel-title"><?= translate('Visitors entered date:_before')?></h1>
						</div>
						<div class="col-md-6 form-group">
							<input type="date"  class="form-control date-input" name="va_date" id="va_date">
							<input type="date"  class="form-control date-input" name="vb_date" id="vb_date">
						</div>
						
						<div class="col-md-12 form-group button-form">
							<button type="reset" class="search-button"><?= translate('reset')?></button>
                            &nbsp;
							<button type="submit" class="search-button" data-toggle="modal" data-target="#staticBackdrop"><?= translate('next')?></button>
						</div>
					<!-- </form> -->
				</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="staticBackdropLabel"><?= translate('Chapter Email Visitors')?></h5>
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true"><i class="fa fa-close fa-lg"></i></span>
									</button>
								</div>
								<div class="modal-body">
										<h5 class="body-heading">Please copy and paste the list into your email client. Duplicate email addresses have been removed from this list.</h5>
										 <div class="form-group">
											<textarea class="form-control visitor-email" id="visitoe_email" name="visitoe_email" rows="3" style="height: 350px;"></textarea>
										</div>
								</div>
