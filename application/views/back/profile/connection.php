	  ...
	  <!--          </div>-->
		    ...
		    <div class="panel-heading">
                <div class="col-md-12" align="center" style="margin: 9px 0px 0px -20px;">						
                    ...
                    <a href="<?=base_url()?>admin/connection" id="demo-dt-view-btn" class="btn btn-primary add-tooltip"><i class="fa fa-sliders"></i> <?php echo translate('connections')?></a>
                    ...
                    <div class="col-md-6">
                        <div class="col-md-6 connection-container">
                            ...
                            <div class="desc-container">
                                <a href="<?= base_url()?>admin/otherUser"><h5>Lorem, ipsum.</h5></a>
