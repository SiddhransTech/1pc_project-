...
<div id="content-container">
	<div id="page-head">
		...
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<div id="page-title">
			<h1 class="page-header text-overflow" style="display:table-cell"><?= translate('send_message')?></h1>
	...
	<div id="page-content">
	  ...
	  <!--          </div>-->
		    ...
		    <div class="panel-heading">
		        ...
		        <h3 class="panel-title"><?= translate('send_message')?></h3>
				</div>
                <div class="col-md-6" align="right" style="margin: 18px 0px 0px -10px;">		
		    ...
		    <div class="panel-body">
	    		<div class="col-md-12 top-content-button">
                    <div class="col-md-6">
                        <button class="left-buttons"><?= translate('delete_selected')?></button>
                        <a href="<?= base_url()?>admin/composeMessage"><button class="left-buttons"><?= translate('compose')?></button></a>
                    </div>
                        ...
                        <table id="contact_messages_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>data</td>
                                    <td><a href="<?= base_url()?>admin/sentMessage">data</a></td>
                                    <td></td>
                                </tr>
                            </tbody>
                        </table>					
