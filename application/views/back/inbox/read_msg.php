...
<div id="content-container">
	<div id="page-head">
		...
		<ol class="breadcrumb">
			...
			<li><a href="#"><?= translate('read_message')?></a></li>
	...
	<div id="page-content">
	  ...
	  <!--          </div>-->
		    ...
		    <div class="panel-heading">
		        ...
		        <h3 class="panel-title"><?= translate('read_message')?></h3>
				</div>
		    ...
		    <div class="panel-body">
	    		<div class="col-md-12">
                    ...
                    <div class="message-content">
                        <div class="message-container">
                            <div class="col-md-1" align="center" style="font-weight: bolder;"><?= translate('sender_:')?></div>
                            <div class="col-md-11">name</div>
                        </div>
                        <div class="message-container">
                            <div class="col-md-1" align="center" style="font-weight: bolder;"><?= translate('subject_:')?></div>
                            <div class="col-md-11 upperCase">subject of the message</div>
                        </div>
                        <div class="message-container">
                            <div class="col-md-1" align="center" style="font-weight: bolder;"><?= translate('dated_:')?></div>
                ...
                <div class="col-md-12 bottom-container" align="right">
                    <a href="<?= base_url()?>admin/replayMessage"><button class="bottom-button"><?= translate('reply')?></button></a>
