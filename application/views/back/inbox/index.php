...
<div id="content-container">
	<div id="page-head">
		...
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<div id="page-title">
			<h1 class="page-header text-overflow" style="display:table-cell"><?= translate('inbox')?></h1>
	...
	<div id="page-content">
	  ...
	  <!--          </div>-->
		    ...
		    <div class="panel-heading">
		        ...
		        <h3 class="panel-title"><?= translate('inbox')?></h3>
				</div>
                        ...
                        <table id="contact_messages_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>data</td>
                                    <td><a href="<?= base_url()?>admin/readMessage">data</a></td>
                                    <td></td>
                                </tr>
                            </tbody>
                        </table>					
