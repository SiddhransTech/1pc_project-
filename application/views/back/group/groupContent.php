		    ...
		    <div class="panel-body">
                ...
                <div class="tab-content" id="tabContent1">
                    ...
                    <div class="msg-container">
                        ...
                        <div class="col-md-4 button-topic" align="right">
                            <button data-toggle="modal" data-target="#staticBackdrop"><?= translate('add_new_topic')?></button>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 button-topic" align="right">
                        <button data-toggle="modal" data-target="#staticBackdrop"><?= translate('add_new_topic')?></button>
                    </div>
                </div>
                ...
                <div class="tab-content" id="tabContent2">
                    ...
                    <div class="col-md-6 ">
                        <div class="image-container col-md-6">
                            ...
                            <div>
                                <a href="<?= base_url()?>admin/otherUser">name</a>
                     ...
                     <div class="tab-content" id="tabContent3">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr style="border-bottom: 2px solid lightgray;">
                                        ...
                                        <td align="left"  style="color:navy"><a href="<?= base_url()?>admin/otherUser">data</a></td>
                        ...
                        <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog modal-x" style="width: 999px;">
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color:#f8f9fa;overflow:overlay;">
                                    ...
                                    <div class="modal-body" style="padding-bottom: 110px;">
                                        <div class="col-md-12" align="right" style="border-bottom:1px solid #dee2e6">
                                            <span style="color: red;">* </span><?= translate('required_field')?>
                                        </div>
                                        <div class="col-md-12" style="padding: 10px;border-bottom:1px solid #e9ecef;">
                                            <div class="col-md-5" align="right">
                                                <label for="topic_name"><?= translate('topic_name')?></label>
                                        ...
                                        <div class="col-md-12" style="padding: 10px;border-bottom:1px solid #e9ecef;margin-bottom: 10px;">
                                            <div class="col-md-5" align="right">
                                                <label for="topic_desc"><?= translate('description')?></label>
                                                <span style="color: red;">* </span>
                                            </div>
                                            <div class="col-md-7">
                                                <textarea name="topic_desc" id="topic_desc" cols="30" rows="10" style="resize:none"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer" style="background-color:#f8f9fa;overflow:overlay;text-align:center">
                                        <button type="submit" class="modal-buttons"><?= translate('submit')?></button>
