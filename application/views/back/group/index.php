...
<div id="content-container">
	<div id="page-head">
		...
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<div id="page-title">
			<h1 class="page-header text-overflow" style="display:table-cell"><?= translate('public_group')?></h1>
		...
		<ol class="breadcrumb">
			...
			<li><a href="#"><?= translate('public_group')?></a></li>
	...
	<div id="page-content">
	  ...
	  <!--          </div>-->
		    ...
		    <div class="panel-heading">
		        ...
		        <!-- <h3 class="panel-title"><?= translate('public_group')?></h3> -->
				</div>
                <div class="col-md-6" align="right" style="margin: 20px 0px 0px -10px;">		
                    <a href="<?= base_url()?>admin/my_group">
						<button class="top-button"><?= translate('my_group')?></button>
					</a>
												...
												<div class="col-md-12">
													<div class="group-individual">
														...
														<div class="group-right" style="width: 30%;">
																...
																<div>date</div>
																<button class="group-button"><?= translate('join_group')?></button>
														</div>
													</div>
												</div>
