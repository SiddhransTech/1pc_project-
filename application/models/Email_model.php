        ...
        */
        ...
        function password_reset_email($account_type = '', $id = '', $pass = '') {
            ...
            if ($query->num_rows() > 0) {
                ...
                $send_mail = $this->do_email($from, $from_name, $to, $sub, $email_body, $mailtype="html" );
                return $send_mail;
            } else {
                return false;
            }
        ...
        function subscruption_email($account_type = '', $member_id = '', $plan_id = '') {
           ...
           function newsletter($subject = '', $msg = '',  $from = '',$to = '', $users = '') {
            $from_name = $this->db->get_where('general_settings', array('type' => 'system_name'))->row()->value;
      
           
            // $this->do_email($from, $from_name, $email, $title, $text,$to);
             $this->do_email1($from, $from_name,$email, $subject, $msg,$to,$users);
        }
        ...
        // }
             ...
             function do_email1($from = '', $from_name = '', $email = '', $subject = '', $msg = '', $to = '',$users = '', $mailtype = 'html' )
             {
            $config = array();
            $smtp_config = array();
            $protocol = $this->db->get_where('general_settings', array('type' => 'mail_status'))->row()->value;
