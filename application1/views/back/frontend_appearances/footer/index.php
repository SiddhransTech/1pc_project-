		...
		<div class="panel">
			...
			<div class="panel-body">
				<form class="form-horizontal" id="general_settings_form" method="POST" action="<?=base_url()?>admin/save_frontend_settings/update_footer" enctype="multipart/form-data" >
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="guruji_quotes"><b><?php echo translate('guruji_quotes')?></b></label>
						<div class="col-sm-6">
							<textarea class="form-control" id="guruji_quotes" name="guruji_quotes" rows="5"><?=$guruji_quotes?></textarea>
						</div>
					</div>
