		...
		<div class="panel">
			...
			<div class="panel-heading">
				<div class="row">
					...
					<form method="post">
						<div class="col-md-8" align="right" style="margin-top: 9px;">						
							<a class="pull-right btn btn-warning btn-large ea" href="<?php echo base_url();?>admin/groomFreeMember"><i class="fa fa-file-excel-o"></i> Export Groom</a>

							<a class="pull-right btn btn-warning btn-large ea" href="<?php echo base_url();?>admin/bridFreeMember"><i class="fa fa-file-excel-o"></i> Export Bride</a>

							<a class="pull-right btn btn-warning btn-large ea" href="<?php echo base_url();?>admin/exportFreeMemberCSV"><i class="fa fa-file-excel-o"></i> Export All</a>	
						</div>
					</form>
					<?php elseif($parameter == "premium_members"): ?>
						<form method="post">
							<div class="col-md-8" align="right" style="margin-top: 9px;">						
								<a class="pull-right btn btn-warning btn-large ea" href="<?php echo base_url();?>admin/groomPremiumMember"><i class="fa fa-file-excel-o"></i> Export Groom</a>

								<a class="pull-right btn btn-warning btn-large ea" href="<?php echo base_url();?>admin/bridPremiumMember"><i class="fa fa-file-excel-o"></i> Export Bride</a>

								<a class="pull-right btn btn-warning btn-large ea" href="<?php echo base_url();?>admin/exportPremiumMemberCSV"><i class="fa fa-file-excel-o"></i> Export All</a>	
							</div>
						</form>
					<?php endif;?>
				</div>	
                    ...
                    <div class="form-group has-feedback">                        
                      <div class="radio radio-primary">
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                        	<input type="radio" name="free_member_gender" class="ch rba free_member_radio" value="all"  <?php if(!empty($this->session->userdata('free_member_status_type'))) { if($this->session->userdata('free_member_status_type') == 'all') {echo 'checked'; }}else if(empty($this->session->userdata('free_member_status_type'))){ echo 'checked';} ?>>
                        	<label for="all" style="padding-left: 0px;"><?=translate('All')?></label>
                        </div>
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                            <input type="radio" name="free_member_gender" class="rba free_member_radio"  value="bride"  <?php if(!empty($this->session->userdata('free_member_status_type'))) { if($this->session->userdata('free_member_status_type') == 'bride') {echo 'checked'; }} ?>>
                            <label for="bride" style="padding-left: 0px;"><?=translate('bride')?></label>
                        </div>
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                            <input type="radio" name="free_member_gender" class="rba free_member_radio"  value="groom"  <?php if(!empty($this->session->userdata('free_member_status_type'))) { if($this->session->userdata('free_member_status_type') == 'groom') {echo 'checked'; }} ?>>
                            <label for="groom" style="padding-left: 0px;"><?=translate('groom')?></label>
                         </div>
                      </div>
                    </div>
                  </div>          
                  ...
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5">
                    <div class="form-group has-feedback">                        
                      <div class="radio radio-primary">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                          <input type="radio" name="free_filter_status" class="rba free_filter_status_radio"  value="both" <?php if(!empty($this->session->userdata('free_filter_status'))) { if($this->session->userdata('free_filter_status') == 'both') {echo 'checked'; }} ?>>
                          <label for="bride" style="padding-left: 0px;"><?=translate('Both')?></label>
                        </div>
        
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                        	<input type="radio" name="free_filter_status" class="ch rba free_filter_status_radio"   value="approved" <?php if(!empty($this->session->userdata('free_filter_status'))) { if($this->session->userdata('free_filter_status') == 'approved') {echo 'checked'; }} ?> >
                        	<label for="all" style="padding-left: 0px;"><?=translate('Approved')?></label>
                        </div>
        
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                          <input type="radio" name="free_filter_status" class="rba free_filter_status_radio"  value="pending" <?php if(!empty($this->session->userdata('free_filter_status'))) { if($this->session->userdata('free_filter_status') == 'pending') {echo 'checked'; }} ?>>
                  ...
                  <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2" style="margin-left: -70px;">
		            <div class="form-group has-feedback">                        
		              <div class="radio radio-primary">
		              	...
		              	?>
		                <input type="checkbox" name="free_member_profile_image" class="ch rba free_member_image_check" value="default" <?php echo $checked; ?>  
		                   >
              ...
              <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5" style="padding-left: 30px;">
                <div class="form-group has-feedback">                        
                  <div class="radio radio-primary">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                    	<input type="radio" name="premium_member_gender" class="ch rba premium_member_radio" value="all"  <?php if(!empty($this->session->userdata('premium_member_status_type'))) { if($this->session->userdata('premium_member_status_type') == 'all') {echo 'checked'; }}else if(empty($this->session->userdata('premium_member_status_type'))){ echo 'checked';} ?>>
                    	<label for="all" style="padding-left: 0px;"><?=translate('All')?></label>
                    </div>
                    
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                      <input type="radio" name="premium_member_gender" class="rba premium_member_radio" value="bride"  <?php if(!empty($this->session->userdata('premium_member_status_type'))) { if($this->session->userdata('premium_member_status_type') == 'bride') {echo 'checked'; }} ?>>
                      <label for="bride" style="padding-left: 0px;"><?=translate('bride')?></label>
                    </div>
                    
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                      <input type="radio" name="premium_member_gender" class="rba premium_member_radio" value="groom"  <?php if(!empty($this->session->userdata('premium_member_status_type'))) { if($this->session->userdata('premium_member_status_type') == 'groom') {echo 'checked'; }} ?>>
                      <label for="groom" style="padding-left: 0px;"><?=translate('groom')?></label>
                    </div>
              ...
              <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5">
                <div class="form-group has-feedback">                        
                  <div class="radio radio-primary">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                      <input type="radio" name="premium_filter_status" class="rba premium_filter_status_radio"  value="both" <?php if(!empty($this->session->userdata('premium_filter_status'))) { if($this->session->userdata('premium_filter_status') == 'both') {echo 'checked'; }} ?>>
                      <label for="bride" style="padding-left: 0px;"><?=translate('Both')?></label>
                    </div>
    
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                      <input type="radio" name="premium_filter_status" class="ch rba premium_filter_status_radio"   value="approved" <?php if(!empty($this->session->userdata('premium_filter_status'))) { if($this->session->userdata('premium_filter_status') == 'approved') {echo 'checked'; }} ?> >
                      <label for="all" style="padding-left: 0px;"><?=translate('Approved')?></label>
                    </div>
    
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                      <input type="radio" name="premium_filter_status" class="rba premium_filter_status_radio"  value="pending" <?php if(!empty($this->session->userdata('premium_filter_status'))) { if($this->session->userdata('premium_filter_status') == 'pending') {echo 'checked'; }} ?>>
                      <label for="bride" style="padding-left: 0px;"><?=translate('Pending')?></label>
                    </div> 
              ...
              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2" style="margin-left: -70px;">
	            <div class="form-group has-feedback">                        
	              <div class="radio radio-primary">
	              	...
	              	?>
	                <input type="checkbox" name="premium_member_profile_image" class="ch rba premium_member_image_check" value="default" <?php echo $checked; ?>  
	                   >
	                <label for="profile_image" style="padding-left: 0px;"><?=translate('image')?></label>
	              </div>
	            </div>
