		...
		<div class="panel">
		    ...
		    <div class="panel-body">
	    		<form class="form-horizontal" id="manage_details_form" method="POST" action="<?=base_url()?>admin/members/add_member/do_add">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="star"><b><?= translate('Select star')?> <span class="text-danger">*</span></b></label>
						<div class="col-sm-8">
							<?php
                                if (!empty($form_contents)) {
                                    echo $this->Crud_model->star_select_html('nakshtra', 'nakshtra', 'nakshtra', 'edit', 'form-control form-control-sm selectpicker', $form_contents['star'], '', '', '');
                                }
                                else {
                                    echo $this->Crud_model->star_select_html('nakshtra', 'nakshtra', 'nakshtra_name',  'add','form-control form-control-sm selectpicker', '', '', '', '');
                                }
                            ?>
						</div>
					</div>
