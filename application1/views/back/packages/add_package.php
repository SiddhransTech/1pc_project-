			...
			<form class="form-horizontal" id="package_form" method="POST" action="<?=base_url()?>admin/packages/do_add" enctype="multipart/form-data">
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="number" class="form-control" name="express_interest" id="express_interest" value="">	
						</div>
						<div class="col-sm-1">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="number" class="form-control" name="direct_messages" value="" id="direct_messages">
						</div>
						<div class="col-sm-1">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="number" class="form-control" name="video_gallery" value="" required="">
						</div>
					</div>
