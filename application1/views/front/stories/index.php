...
<section class="slice-lg sct-color-1" style="padding-top: 2rem !important; padding-bottom: 4rem !important;">
    <div class="container">
        ...
        <!--    </h3> -->
        <!--    <h2 class="heading heading-3 strong-400 mb-0">Happy Stories</h2>-->
        ...
        <div class="section-title section-title--style-1 text-center mb-4">
            ...
            <h2 class="heading heading-3 strong-400 mb-0"><?= translate($member) ?> <?php echo translate('happy_stories') ?></h2>
