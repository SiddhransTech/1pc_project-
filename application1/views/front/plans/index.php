    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-12 text-center">
                ...
                <h2 class="heading heading-3 strong-400 mb-0"><?= translate($member) ?> <?php echo translate('premium_plans') ?></h2>
                        ...
                        <div class="icon-block--style-1-v5 text-center">
                            <div class="block-icon c-gray-dark">
                                ...
                                <?php
                                    ...
                                    ?>
                                        <img src="<?=base_url()?>uploads/plan_image/<?=$images[0]['thumb']?>" alt="plan" class="img-sm" height="100">
                                    <?php
                                    }
                                    else {
                                    ?>
                            ...
                            <div class="block-content">
                                ...
                                <ul class="pl-0 pr-0 mt-0">
                                    ...
                                    <!--<li class="<?=$package_class?> package_items"><?=translate('video_gallery:')?> <?=$value->video_gallery?> <?=translate('videos')?></li>-->
                                </ul>
                                <div class="py-2 text-center mb-2">
                                    ...
                                    <a href="<?=$purchase_link?>" class="btn btn-styled btn-sm btn-base-1 btn-outline btn-circle">
                                        <span class="<?=$package_class?>"><?php echo translate('buy_now')?></span>
                                    </a>
                                </div>
                            </div>
                        </div>
