                                ...
                                <div class="container">
                                    <div class="row cols-xs-space cols-sm-space cols-md-space">
                                        <?php
                                            ...
                                            $guruji_quotes=$this->db->get_where('frontend_settings', array('type'=>'guruji_quotes'))->row()->value;
                                                    ...
                                                    <div class="col">
                                                        <a class="navbar-brand" href="#">
                                                            <?php
                                                                ...
                                                                ?>
                                                                    <img src="<?=base_url()?>uploads/footer_logo/<?=$footer_logo[0]['image']?>" alt="footer_logo" class="img-responsive" width="100%">
                                                                <?php
                                                                }
                                                                else {
                                                                ?>
                                        ...
                                        <div class="col-md-3 col-lg-3">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-3" style="padding: 0px !important;">
                                                    <img src="<?php echo base_url();?>uploads/guruji_photos/<?php echo $row->guruji_photo;?>" height="80" width="80" alt="image" style="padding: 6px 6px;">  
                                                    <!--<div class="text-center"><?php echo substr($row->guruji_name,0,7);?></div>-->
                                                </div>
                                                <?php } } ?>
                                            </div>
                                            <div class="text-center" style="border: thin double; font-size: x-large;"><?=$guruji_quotes?></div>
