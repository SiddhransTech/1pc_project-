...
<html>
    <head>
        ...
        <?php
            ...
            elseif ($theme_color == 'lightseagreen') { ?>
                <link id="stylesheet" type="text/css" href="<?=base_url()?>template/front/css/global-style-lightseagreen.css" rel="stylesheet" media="screen">
            <?php
            }
        ?>
                        ...
                        <div class="form-card form-card--style-2 z-depth-3-top">
                            <div class="form-body">
                                ...
                                <form class="form-default" role="form" method="post" action="<?=base_url()?>home/check_login">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="text-uppercase font_light"><?php echo translate('email_or_mobile')?></label>
                                                <input type="text" class="form-control input-sm" name="email" id="inp_usr_nm" autofocus required >
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  <!--   <div class="col-12">-->
                                  <!--         <div class="form-group">-->
                                  <!--            <label class="text-uppercase font_light"><?php echo translate('mobile')?></label>-->
                                  <!--           <input type="text" class="form-control input-sm" name="mobile" id="inp_usr_mobile" autofocus >-->
                                  <!--        </div>-->
                                  <!--     </div>-->
                                  <!--</div> -->
