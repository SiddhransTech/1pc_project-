    ...
    <div class="container">
        ...
        <div class="section-title section-title--style-1 text-center mb-4">
          <?php if (!empty($offers_data)) { ?>
            ...
            <h2 class="heading heading-3 strong-400 mb-0"><?= translate($member) ?> <?php echo translate('contact_us') ?></h2>
            ...
            <div class="box">                           
                <div class="icon">
                    ...
                    <div class="info">
                        ...
                        <p>
                            <i class="fa fa-envelope" aria-hidden="true"></i> &nbsp support@edigamatchmaker.com
                            <br>
                            <br>
            ...
            <div class="box">                           
                <div class="icon">
                    ...
                    <div class="info">
                        ...
                        <p>
                            <i class="fa fa-mobile" aria-hidden="true"></i> &nbsp 6364128081
                            <br>
                            <br>
