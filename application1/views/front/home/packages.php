                        ...
                        <div class="icon-block--style-1-v5 text-center">
                            <div class="block-icon c-gray-dark">
                                ...
                                <?php
                                    ...
                                    ?>
                                        <img src="<?=base_url()?>uploads/plan_image/<?=$images[0]['thumb']?>" alt="plan" class="img-sm" height="80">
                                    <?php
                                    }
                                    else {
                                    ?>
                            ...
                            <div class="block-content">
                                ...
                                <ul class="pl-0 pr-0 mt-0">
                                    ...
                                    <!--<li class="<?=$package_class?> package_items"><?=translate('video_gallery')?> <?=$value->video_gallery?> <?=translate('video')?></li>-->
                                </ul>
